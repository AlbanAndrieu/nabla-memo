...
# See https://github.com/ix-plugin-hub/iocage-plugin-index/blob/master/paperless-ngx.json
/tmp/paperless.json
{
  "pkgs": [
  "py39-pip",
...
pkg version -v
# error ping pkg.FreeBSD.org

# Switch to NAT instead of dhcp to have network
pkg update
