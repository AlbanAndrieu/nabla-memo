...
# for ansible-cmdb to do inventory on pfsense
...
# NOK sudo apt install node-grunt-cli
...
# pyenv update
# Remove pyenv 3.10.9 and re install
...
# Add extension on chrome : https://chromewebstore.google.com/detail/gnome-shell-integration/gphhapmejobijbbhgpjhcjognlahblep
