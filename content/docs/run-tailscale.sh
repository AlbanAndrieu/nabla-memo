...
# puma-beaufort.ts.net

# https://github.com/juanfont/headscale
# https://deep75.medium.com/headscale-une-impl%C3%A9mentation-open-source-et-auto-h%C3%A9berg%C3%A9e-du-serveur-de-contr%C3%B4le-tailscale-c0af024d4df0
...
# (warnable=no-derp-connection): error: Tailscale could not connect to the 'Paris' relay server.
tailscale netcheck
...
# https://github.com/KornelJahn/truenas-core-tailscale-jail
...
# TODO https://www.cyberciti.biz/faq/how-to-import-wireguard-profile-using-nmcli-on-linux/
