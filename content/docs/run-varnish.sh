...
sub vcl_recv {
  if (req.http.host == "fr1cslfrbm0059.albandrieu.com" || req.http.host == "www.fr1cslfrbm0059.albandrieu.com") {
      set req.backend_hint = apache1;
  }
  elseif (req.http.host == "fr1cslfrbm0060.albandrieu.com" || req.http.host == "www.fr1cslfrbm0060.albandrieu.com") {
