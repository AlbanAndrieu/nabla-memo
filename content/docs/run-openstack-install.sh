...
dns-search france.effix.fr albandrieu.com
...
|   name   |              admin               |
+----------+----------------------------------+
#Cr�ation du compte interne du service Glance
...
|   name   |              glance              |
+----------+----------------------------------+
#Cr�ation du compte interne du service Nova
